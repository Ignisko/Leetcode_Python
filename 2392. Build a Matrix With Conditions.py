...
class Solution(object):
    def buildMatrix(self, k, rowConditions, colConditions):
        ...
        def topsort(k, conditions):
            ...
            queue = deque([node for node in indeg if indeg[node] == 0])
            order = []
        ...
        roworder = topsort(k, rowConditions)
        colorder = topsort(k, colConditions)
        ...
        for idx, val in enumerate(roworder):
            matrix[idx][colpos[val]] = val
